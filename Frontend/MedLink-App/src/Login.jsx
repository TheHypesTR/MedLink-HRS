    ...
    return (
            ...
            <div className='formbox-login'>
                <form onSubmit={girisYap}>
                    ...
                    <div><span className='icon2'><img src='./src/assets/username.png' alt='username' className='icon3' /></span><input type="text" placeholder="T.C Kimlik No" className='input-box2'/></div>
                    <div><span className='icon2'><img src="./src/assets/password.jpg" alt="password" className='icon3'/></span><input type="password" placeholder="Şifre" className='input-box2' /></div>
